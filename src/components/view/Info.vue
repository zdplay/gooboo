...
export default {
  ...
  data: () => ({
    ...
    updateItems: [
      ...
      { category: '农场', color: 'brown', content: '在农场货币中显示掉落来源。', isCurrentUpdate: true },
      ...
      { category: '事件', color: 'blue', content: '增加天气混乱事件萌新钓竿和海贼王宝藏，钓鱼日志，互动钓鱼小游戏。', isCurrentUpdate: true },
      { category: '事件', color: 'blue', content: '调整天气混乱事件鱼哨的钓鱼力量加成为2倍，调整2图垃圾增益为塑料，藻类增益改到4图。', isCurrentUpdate: true },
