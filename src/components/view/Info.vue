...
export default {
  ...
  data: () => ({
    ...
    updateItems: [
      ...
      { category: '村庄', color: 'indigo', content: '在蒸汽机阶段增加机械矿场升级项目，解锁遥控矿车工作种类，大幅提高金属产量。', isCurrentUpdate: false },
      ...
      { category: '部落', color: 'red', content: '调整装备配置能同步保存装备自动施法和禁用主动技能状态。', isCurrentUpdate: true },
      ...
      { category: '画廊', color: 'orange', content: '增加画廊灵感重置功能，可重置所有创意等级和灵感点数，在【设置】-【实验性】中开关。', isCurrentUpdate: true },
      ...
      { category: '其他', color: 'cyan', content: '增加菜单栏快捷按钮功能，在【设置】-【实验性】中开启。', isCurrentUpdate: true },
