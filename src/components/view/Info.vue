...
export default {
  ...
  data: () => ({
    ...
    updateItems: [
      ...
      { category: '画廊', color: 'orange', content: '增加画廊创意模版功能，在【设置】-【实验性】中开关。', isCurrentUpdate: true },
      ...
      { category: '其他', color: 'cyan', content: '增加兑换码功能，用来补偿部分玩家的损失。', isCurrentUpdate: true },
      { category: '冰冻实验室', color: 'blue', content: '增加双开门冰箱功能，扩展为冷藏和冷冻双系统，同时使用时1.3倍效果。', isCurrentUpdate: false },
      { category: '事件', color: 'dark-blue', content: '增加【指定赌场事件】功能，开启后可手动选择进入宾果或转盘，在【设置】-【实验性】中开关。', isCurrentUpdate: true },
    ],
    categoryIcons: {
      '设置': 'mdi-cog',
      '挖矿': 'mdi-pickaxe',
