...
export default {
  ...
  gooboo: {
    ...
    cloudloadlatest: '【Neueste Version aus der Cloud laden】',
    cloudloadlist: '【Cloud-Speicherliste】',
  ...
  eventHourglass: {
    title: 'Ereignis-Stundenglas',
    subtitle: 'Nutze Amethyst, um das aktuelle Ereignis zu beschleunigen',
    timeInMinutes: 'Zeit (in Minuten)',
    description: 'Jeder verbrauchte Amethyst beschleunigt das aktuelle Ereignis um 1,5 Minuten'
  },
  cryolab: {
  ...
  settings: {
    ...
    experiment: {
      ...
      dailyCheckIn: {
        ...
        description: 'Zeigt die tägliche Anmeldeschaltfläche an, ermöglicht einmal täglich die Anmeldung, um zufällige Belohnungen zu erhalten'
      },
      currencyLabel: {
